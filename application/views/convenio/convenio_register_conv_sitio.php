<form method ="post" action="<?php echo base_url()?>convenio/registrar_conv_sitio">
	<?php if(isset($ok) && $ok):?>
		<div class="ok">
	...
	<h2>Registro de convenio para los sitios turisticos</h2>
	...
	<div class="groupButton">
		...
		<button type="button" class="consultar" data-link="<?php echo base_url()?>convenio/consultar_convenio_sitio"><span></span>Consultar</button>
	</div>
</form>