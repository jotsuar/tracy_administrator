<form method ="post" action="<?php echo base_url()?>tipo_habitacion">
	<?php if(isset($ok) && $ok):?>
		<div class="ok">
	...
	<?php endif;?>
	<h2>Registro de Tipo de Habitaciòn</h2>
	...
	<div class="groupButton">
		<button type="button" class="consultar" data-link="<?php echo base_url()?>tipo_habitacion/consultar"><span></span>Consultar</button>
