<form method = "post" id = "form" action = "<?php echo base_url()?>transporte/registrar">
	<?php if(isset($ok) && $ok):?>
	...
	<div class = "group_button">
		<button type = "button" class = "data btn" data-link = "<?php echo base_url()?>transporte/consultar">
