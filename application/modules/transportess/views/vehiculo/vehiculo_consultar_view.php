<button type="button" class="data btn volver" data-link="<?php echo base_url()?>transporte/vehiculo">
	<span class = "glyphicon glyphicon-chevron-left"></span> Volver
</button>
<form method ="post" id = "form" class="form_consult" action="<?php echo base_url()?>transporte/vehiculo/consultar">
