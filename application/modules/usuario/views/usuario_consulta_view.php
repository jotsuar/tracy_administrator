<?php  if ($fecha):?>
					<button type="button" class = "data btn volver" data-link="<?php echo base_url()?>login/indexxº">
	<span class = "glyphicon glyphicon-chevron-left"></span> Volver
</button>
					<?php endif?>


<form method ="post" id="form" class="form_consult" action="<?php echo base_url().$action?>">
