<form method = "post" id = "form" action = "<?php echo base_url()?>transport_company/modificar_tipo_vehiculo">
	<?php if(isset($ok) && $ok):?>
	...
	<div class = "group_button">
		<button type = "button" class = "data btn" data-link = "<?php echo base_url()?>transport_company/consultar_tipo_vehiculo">
